...
// CountExpiredNode is a free data retrieval call binding the contract method 0xc2d20bad.
//
// Solidity: function countExpiredNode() constant returns(uint256)
func (_Contract *ContractCaller) CountExpiredNode(opts *bind.CallOpts) (*big.Int, error) {
	var (
		ret0 = new(*big.Int)
	)
	out := ret0
	err := _Contract.contract.Call(opts, out, "countExpiredNode")
	return *ret0, err
}
...
//
// Solidity: function countExpiredNode() constant returns(uint256)
func (_Contract *ContractSession) CountExpiredNode() (*big.Int, error) {
	return _Contract.Contract.CountExpiredNode(&_Contract.CallOpts)
}

// CountExpiredNode is a free data retrieval call binding the contract method 0xc2d20bad.
//
// Solidity: function countExpiredNode() constant returns(uint256)
func (_Contract *ContractCallerSession) CountExpiredNode() (*big.Int, error) {
	return _Contract.Contract.CountExpiredNode(&_Contract.CallOpts)
}
...
// ExpiredNodesOf is a free data retrieval call binding the contract method 0x7c6aeeef.
//
// Solidity: function expiredNodesOf(address ) constant returns(uint256)
func (_Contract *ContractCaller) ExpiredNodesOf(opts *bind.CallOpts, arg0 common.Address) (*big.Int, error) {
	var (
		ret0 = new(*big.Int)
	)
	out := ret0
	err := _Contract.contract.Call(opts, out, "expiredNodesOf", arg0)
	return *ret0, err
}
...
//
// Solidity: function expiredNodesOf(address ) constant returns(uint256)
func (_Contract *ContractSession) ExpiredNodesOf(arg0 common.Address) (*big.Int, error) {
	return _Contract.Contract.ExpiredNodesOf(&_Contract.CallOpts, arg0)
}

// ExpiredNodesOf is a free data retrieval call binding the contract method 0x7c6aeeef.
//
// Solidity: function expiredNodesOf(address ) constant returns(uint256)
func (_Contract *ContractCallerSession) ExpiredNodesOf(arg0 common.Address) (*big.Int, error) {
	return _Contract.Contract.ExpiredNodesOf(&_Contract.CallOpts, arg0)
}
...
// GetRefIds is a free data retrieval call binding the contract method 0x0cab529c.
//
// Solidity: function getRefIds(address addr, uint256 startPos) constant returns(uint256 length, bytes8[5] data)
func (_Contract *ContractCaller) GetRefIds(opts *bind.CallOpts, addr common.Address, startPos *big.Int) (struct {
	Length *big.Int
	Data   [5][8]byte
}, error) {
	ret := new(struct {
	...
	out := ret
	err := _Contract.contract.Call(opts, out, "getRefIds", addr, startPos)
	return *ret, err
}
...
//
// Solidity: function getRefIds(address addr, uint256 startPos) constant returns(uint256 length, bytes8[5] data)
func (_Contract *ContractSession) GetRefIds(addr common.Address, startPos *big.Int) (struct {
	Length *big.Int
	Data   [5][8]byte
}, error) {
...
//
// Solidity: function getRefIds(address addr, uint256 startPos) constant returns(uint256 length, bytes8[5] data)
func (_Contract *ContractCallerSession) GetRefIds(addr common.Address, startPos *big.Int) (struct {
	Length *big.Int
	Data   [5][8]byte
}, error) {
	return _Contract.Contract.GetRefIds(&_Contract.CallOpts, addr, startPos)
...
// MiningPeriod is a free data retrieval call binding the contract method 0x92eb1b40.
//
// Solidity: function miningPeriod() constant returns(uint256)
func (_Contract *ContractCaller) MiningPeriod(opts *bind.CallOpts) (*big.Int, error) {
	var (
		ret0 = new(*big.Int)
	)
	out := ret0
	err := _Contract.contract.Call(opts, out, "miningPeriod")
	return *ret0, err
}
...
//
// Solidity: function miningPeriod() constant returns(uint256)
func (_Contract *ContractSession) MiningPeriod() (*big.Int, error) {
	return _Contract.Contract.MiningPeriod(&_Contract.CallOpts)
}

// MiningPeriod is a free data retrieval call binding the contract method 0x92eb1b40.
//
// Solidity: function miningPeriod() constant returns(uint256)
func (_Contract *ContractCallerSession) MiningPeriod() (*big.Int, error) {
	return _Contract.Contract.MiningPeriod(&_Contract.CallOpts)
}
...
// Renew is a paid mutator transaction binding the contract method 0xaeb3d39b.
//
// Solidity: function renew(bytes8 id) returns()
func (_Contract *ContractTransactor) Renew(opts *bind.TransactOpts, id [8]byte) (*types.Transaction, error) {
	return _Contract.contract.Transact(opts, "renew", id)
}

// Renew is a paid mutator transaction binding the contract method 0xaeb3d39b.
//
// Solidity: function renew(bytes8 id) returns()
func (_Contract *ContractSession) Renew(id [8]byte) (*types.Transaction, error) {
	return _Contract.Contract.Renew(&_Contract.TransactOpts, id)
}

// Renew is a paid mutator transaction binding the contract method 0xaeb3d39b.
//
// Solidity: function renew(bytes8 id) returns()
func (_Contract *ContractTransactorSession) Renew(id [8]byte) (*types.Transaction, error) {
	return _Contract.Contract.Renew(&_Contract.TransactOpts, id)
}

// Reset is a paid mutator transaction binding the contract method 0xe781ecb9.
//
// Solidity: function reset(bytes32 id1, bytes32 id2, bytes8 oldId) returns()
func (_Contract *ContractTransactor) Reset(opts *bind.TransactOpts, id1 [32]byte, id2 [32]byte, oldId [8]byte) (*types.Transaction, error) {
	return _Contract.contract.Transact(opts, "reset", id1, id2, oldId)
}

// Reset is a paid mutator transaction binding the contract method 0xe781ecb9.
//
// Solidity: function reset(bytes32 id1, bytes32 id2, bytes8 oldId) returns()
func (_Contract *ContractSession) Reset(id1 [32]byte, id2 [32]byte, oldId [8]byte) (*types.Transaction, error) {
	return _Contract.Contract.Reset(&_Contract.TransactOpts, id1, id2, oldId)
}

// Reset is a paid mutator transaction binding the contract method 0xe781ecb9.
//
// Solidity: function reset(bytes32 id1, bytes32 id2, bytes8 oldId) returns()
func (_Contract *ContractTransactorSession) Reset(id1 [32]byte, id2 [32]byte, oldId [8]byte) (*types.Transaction, error) {
	return _Contract.Contract.Reset(&_Contract.TransactOpts, id1, id2, oldId)
}
