...
import (
	...
	"github.com/auchain/auchain/common/bytesutil"
)
...
var defaultMasternodeConfig = &MasternodeChainConfig{
	...
	// Testnet misc values.
	TestnetContractEndpoint: "https://www.auc.org/contract", // defines an http endpoint to fetch the testnet contract addr.
}
