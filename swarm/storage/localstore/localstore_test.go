...
import (
	...
	ch "github.com/auchain/auchain/swarm/chunk"
	"github.com/auchain/auchain/swarm/shed"
...
//
// # go test -benchmem -run=none github.com/auchain/auchain/swarm/storage/localstore -bench BenchmarkNew -v -timeout 20m
// goos: darwin
// goarch: amd64
